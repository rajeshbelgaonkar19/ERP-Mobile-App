...
final admissionPendingCountProvider = FutureProvider<List<dynamic>>((ref) {
  return ref.read(admissionServiceProvider).getPendingCounts();
});

final academicYearsProvider = FutureProvider<List<dynamic>>((ref) {
  return ref.read(admissionServiceProvider).getAcademicYears();
});

final cutoffTrendProvider = FutureProvider<List<dynamic>>((ref) {
  return ref.read(admissionServiceProvider).getCutoffTrend();
});
